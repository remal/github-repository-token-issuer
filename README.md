...
| `repository owner ID N is not allowed`                | Repository owner's account ID not in configured allowlist                  | Contact administrator to add the owner's account ID to GITHUB_ALLOWED_OWNER_IDS                                                                             |
